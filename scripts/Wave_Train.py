...
if __name__ == '__main__':
    ...
    for i in range(start_trial, len(vac1)):
        ...
        #Calculating Magnetic Field Angle (Possibly Average over the Magnetic Field)
        #------------------------------------------------------------------------------------
        ...
        j = 0
        while another_sec == 'y':
            #Plotting V1-4 vs time and Saving to 'data output' Directory
            #------------------------------------------------------------------------------------
            ...
            if v5_inclde == True:
                ...
                time_lag_5 = x_corr_v5[2]

            time_lag_12 = x_corr_v12[2]
            time_lag_34 = x_corr_v12[2]
            ...
            with open(log_file, 'a') as f: 
                ...
                f.write('{}'.format(angle_wave_v1))
                f.write('\n'*2)

                f.write("Speed of the Wave V1 to V2 [km/s]\n")
                f.write('{}'.format(vel_12.value))
                f.write('\n'*2)

                f.write("Speed of the Wave V3 to V4 [km/s]\n")
                f.write('{}'.format(vel_34.value))
                f.write('\n'*2)
